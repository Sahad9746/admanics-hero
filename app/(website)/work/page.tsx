...
export default async function WorkPage() {
  ...
  const demoWorks = [
        ...
        },
        {
            ...
            client: "Nike",
            category: "Social Media",
            videoUrl: "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/Volcanos.mp4",
    ...
    <div className="bg-neutral-950 min-h-screen pt-32 pb-24">
      <div className="max-w-[90rem] mx-auto px-6 md:px-12">
        ...
        <div className="mb-24 md:mb-32">
            <h1 className="text-6xl md:text-[10rem] font-black tracking-tighter text-white leading-[0.9] mb-8">
                SELECTED <br/>
            ...
            <p className="text-neutral-400 max-w-2xl text-xl md:text-2xl leading-relaxed font-light">
                A curated collection of visual narratives designed to captivate and convert. 
            </p>
        </div>

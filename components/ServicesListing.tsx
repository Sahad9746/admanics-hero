...
function PillarSection({ pillar, services: pillarServices, reverse }: { pillar: keyof typeof pillarDetails & keyof typeof pillarMetadata, services: Service[], reverse?: boolean }) {
  ...
  return (
    <div ref={sectionRef} className="flex flex-col lg:flex-row gap-16 lg:gap-32 items-start relative group/section min-h-[80vh]">
      ...
      <div className={cn(
        ...
        >
          ...
          {/* Subtle Pillar Glow */}
          <div className={cn("absolute inset-0 bg-gradient-to-br to neutral-950/20 mix-blend-overlay", details.bgClass)} />
          <motion.div 
            style={{ opacity }} 
            ...
            >
              <div className="group flex flex-col py-6 border-b border-white/5 hover:bg-white/[0.04] transition-all px-6 rounded-2xl -mx-6 cursor-default hover:pl-8">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xl md:text-2xl font-bold transition-colors text-neutral-400 group-hover:text-white">
                    {service.title}
                  </span>

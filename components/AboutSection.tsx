  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none select-none">
        <motion.span style={{ y }} className="text-cinematic whitespace-nowrap">
          SYSTEMS
        </motion.span>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10 px-4 md:px-8">
        <div className="flex flex-col items-start text-left gap-8 md:gap-10">
          ...
          <GradientText
            ...
            className="text-heading-hero max-w-6xl"
          />
          ...
          >
            <p className="text-xl md:text-2xl text-neutral-400 leading-relaxed font-medium">
              Admanics is an AI-driven marketing and technology agency built to
              eliminate manual complexity and drive predictable growth. We
              replace fragmented workflows and manual effort with intelligent,
              automated systems that connect your entire operation.
            </p>
            <p className="text-xl md:text-2xl text-neutral-400 leading-relaxed font-medium">
              By combining deep expertise in global markets with AI-powered
              tools, we build long-term growth infrastructure—not short-term
              campaigns—so your business can scale predictably and grow without
              operational chaos.
            </p>
          </motion.div>
        </div>

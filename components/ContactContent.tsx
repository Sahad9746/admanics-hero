...
const WorldMap = dynamic(() => import("@/components/ui/world-map"), {
  ssr: false,
  loading: () => (
    <div className="w-full h-full bg-neutral-900/20 animate-pulse rounded-[2.5rem]" />
  ),
});
...
export function ContactContent() {
  ...
  const selectedCountryData = useMemo(() => {
    return (
      countries.find((c) => c.dial_code === selectedCountry) || countries[0]
    );
  ...
  useEffect(() => {
    ...
    fetch(
      "https://cdn.prod.website-files.com/5d829bf092d4644f5c42e0ea/5def871cca4d3b3d86d6ee1b_Success-Pack9-smooth.json",
    )
      .then((res) => res.json())
      ...
      try {
        ...
        try {
          ...
          if (geoData.country_code) {
            const matched = formattedCountries.find(
              (c: Country) => c.code === geoData.country_code,
            );
            if (matched) {
            ...
            <div className="flex flex-col justify-center order-2 lg:order-1">
              <div className="flex flex-col items-start gap-6 mb-12">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-label text-neutral-500">Connect</span>
                </div>
                ...
                <GradientText
                  ...
                  as="h1"
                />
                <p className="text-body-lg text-neutral-400 mt-4 max-w-lg">
                  Ready to deploy intelligent growth systems? Tell us about your
              ...
              >
                ...
                {success && (
                  ...
                  >
                    ...
                    >
                      ...
                      <h3 className="text-heading-md text-white mb-3 relative z-10">
                        Message Sent
                      </h3>
                      <p className="text-neutral-400 mb-8 relative z-10">
                        Our intelligence team has received your briefing. We
                        will analyze your requirements and respond shortly.
                      </p>
                      <Button
                        type="button"
                ...
                <div className="space-y-2">
                  ...
                  >
                    Phone{" "}
                    <span className="text-neutral-600 normal-case tracking-normal font-normal ml-1">
                      (Optional)
                    </span>
                  </label>
                    ...
                    <div className="relative">
                      ...
                      >
                        <span className="text-xl sm:text-2xl">
                          {selectedCountryData?.flag || "🏳️"}
                        </span>
                        <span className="font-medium text-sm sm:text-base">
                          {selectedCountry}
                        </span>
                        <ChevronDown
                          className={`w-3 h-3 sm:w-4 sm:h-4 text-neutral-500 transition-transform ${isCountryModalOpen ? "rotate-180" : ""}`}
                        />
                      </button>
                  ...
                  {error?.phone && (
                    <p className="text-red-400 text-xs mt-1">{error.phone}</p>
                  )}
                </div>
                  ...
                  <div className="bg-neutral-950/80 backdrop-blur-xl p-6 rounded-3xl border border-white/10 space-y-6">
                    ...
                    <div className="group flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a
                          href="tel:9900454378"
                          className="text-base sm:text-lg font-bold text-white hover:text-blue-400 transition-colors block"
                        >
                          9900454378
                        </a>
                      </div>
                    ...
                    <div className="group flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a
                          ...
                          className="text-xs font-bold text-blue-400 hover:text-blue-300 transition-colors flex items-center gap-1 uppercase tracking-wider mt-2"
                        >

          ...
          <div className="flex flex-col items-center gap-12 w-full">
            {navItems.map((item, idx) => (
              <motion.a
                ...
                className="text-heading-md text-white hover:text-blue-500 transition-colors"
                onClick={(e: React.MouseEvent) =>
                  handleScroll(e as any, item.link)
                }
              >
                {item.name}
              </motion.a>
            ...
            >
              ...
              <div className="flex gap-8">
                {["Instagram", "LinkedIn", "Facebook"].map((social) => (
                  <span
                    key={social}
                    className="text-sm font-bold text-white/50 hover:text-white transition-colors cursor-pointer"
                  >
                    {social}
                  </span>
                ))}

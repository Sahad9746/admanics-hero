...
export function CategoryDetail({ category, services }: CategoryDetailProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen bg-neutral-950 text-white font-sans selection:bg-blue-500/30 overflow-x-hidden relative"
    >
        ...
        <section className="relative pt-32 md:pt-48 pb-48 px-6 md:px-12 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-end">
            <div className="max-w-4xl">
              ...
              >
                <span className="inline-block text-label text-blue-500 mb-8">
                  System Pillar / {category}
                </span>

                <GradientText
                  words={metadata.title}
                  className="text-heading-hero mb-12 block"
                />
                ...
                <div className="flex flex-col gap-8 md:gap-12">
                  ...
                  <div className="flex-1 border-l-2 border-blue-500/30 pl-8 py-2">
                    <span className="text-label text-neutral-500 mb-2">
                      Target Outcome
                    </span>
        ...
        <section className="relative py-32 px-6 md:px-12 bg-neutral-950 border-t border-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="mb-24">
              ...
              <h2 className="text-heading-xl text-white">The Blueprint.</h2>
              <p className="text-body-lg text-neutral-400 mt-6 max-w-2xl">
                Our {category} architecture is a precision-engineered system
                designed to translate business objectives into high-fidelity
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {(category === "Marketing"
                ? [
                    {
                      ...
                      desc: "Digital ecosystem mapping, performance benchmarking, and target synthesis.",
                      icon: <Search className="w-6 h-6" />,
                    },
                    {
                      step: "02",
                      title: "System Architecting",
                      desc: "Funnel engineering, creative mapping, and technical infrastructure setup.",
                      icon: <Layout className="w-6 h-6" />,
                    },
                    {
                      step: "03",
                      title: "Execution & Scale",
                      desc: "Active optimization, algorithmic adjustments, and budget scaling.",
                      icon: <Zap className="w-6 h-6" />,
                    },
                    {
                      step: "04",
                      title: "Success Synthesis",
                      desc: "Data interpretation, attribution modeling, and strategic reporting.",
                ...
                : [
                    {
                      ...
                      desc: "AI-driven perception mapping and digital footprint vulnerability analysis.",
                      icon: <Fingerprint className="w-6 h-6" />,
                    },
                    {
                      step: "02",
                      title: "Defensive Blueprinting",
                      desc: "Authority building strategy and sentiment stabilization roadmap.",
                      icon: <ShieldCheck className="w-6 h-6" />,
                    },
                    {
                      step: "03",
                      title: "Active Neutralization",
                      desc: "Rapid response protocols and algorithmic visibility management.",
                      icon: <Eye className="w-6 h-6" />,
                    },
                    {
                      step: "04",
                      title: "Reputation Security",
                      desc: "Perpetual monitoring and digital asset safeguarding.",
                ...
                >
                  ...
                  <p className="text-body-md text-neutral-500 leading-relaxed group-hover:text-neutral-400 transition-colors">
                    {item.desc}
                  </p>
                </motion.div>
              ))}
        ...
        >
          ...
          >
            ...
            >
              ...
              <h2 className="text-heading-xl text-white mb-6 md:mb-10">
                {service.title}
              </h2>

              <p className="text-body-lg text-neutral-400 mb-8 md:mb-12 max-w-xl">
              ...
              <Link href="/contact">
                <Button
                  variant="outline"
                  className="bg-transparent text-white rounded-full px-10 py-7 border-white/10 hover:border-white/40 hover:bg-white/5 text-body-lg font-bold transition-all group/btn"
                >
          ...
          <div className={cn("relative", idx % 2 !== 0 && "lg:order-1")}>
            <motion.div
              ...
              <div className="relative aspect-[2/1] md:aspect-[16/10] overflow-hidden rounded-3xl md:rounded-none border border-white/10 md:border-none mb-8 md:mb-0 group bg-neutral-900/20">
                ...
                {!service.image && !service.lottieUrl && (
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 opacity-20 group-hover:opacity-40 transition-opacity">
                    <Icon
                      className="w-32 h-32 md:w-80 md:h-80 text-blue-400"
                      strokeWidth={0.5}
                    />
                  </div>
                )}
                ...
                <div className="absolute top-4 md:top-8 right-4 md:right-8 z-30">
                  <span className="px-4 md:px-6 py-1.5 md:py-2 rounded-full border border-white/10 bg-neutral-950/60 backdrop-blur-xl text-label text-blue-500">
                    {service.outcome}
                  </span>
                </div>
              </div>
